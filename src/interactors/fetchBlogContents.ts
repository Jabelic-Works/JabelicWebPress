 ...
 * @returns contents
 */
export const useFetchBlogContent = async (id: string | string[],currentLocale: Locales, config: {apikey:string, enApikey:string, apiEndpoint: string, enApiEndpoint: string} ,isObject?: boolean):Promise<Article> => {
